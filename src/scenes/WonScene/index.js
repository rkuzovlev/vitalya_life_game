...
Конечно же в ход идет криптовалюта, различные железяки для компа (например видеокарта), да и вобще можешь присылать всякий хлам который тебе уже не нужен но он еще может быть полезен.`;
